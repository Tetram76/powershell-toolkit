...
Codec non mappé (`mpeg4`, `mov_text`, …) : pas de sidecar au split, keep dans le MKV au merge. Chapitres sidecar : `film.chapters.ffmeta`. Aucun objet pipeline. Importer `Tetram.Media.Streams.psd1` (PowerShell 7+).
