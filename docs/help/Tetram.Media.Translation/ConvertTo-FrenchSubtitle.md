...
Les principales étapes longues peuvent être journalisées via le mécanisme d'information/verbose du toolkit : téléchargement éventuel du modèle Ollama, invocation du provider et reconstruction du sous-titre.
