...
Nettoyage de dossiers vides uniquement (pas de fichiers). Une seule commande exportée. Importer `.\Tetram.Remove-Empty-Dirs.psd1`. Pour vider les parents qui ne le deviennent qu'après coup : `-DeepScan`. Toujours `-WhatIf` d'abord.
